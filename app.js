const quotes = {
  ...
  console.log(Object.entries(quotes)); // возвращает массив пар [ключ, значение].
  console.log(Object.keys(quotes)); // возвращает массив ключей. Авторов
  console.log(Object.values(quotes)); // возвращает массив значений. Фраз


let btn = document.querySelector('#quote-generator')
...
function generate() {
    ...
    // Получим всех авторов
    let authors = Object.keys(quotes);
    // Получим рандомного автора
    let randomAuthor = authors[Math.floor(Math.random() * authors.length)];
    console.log(randomAuthor);
    // Получим фразу которая принадлежит randomAuthor
    let randomQuote = quotes[randomAuthor]
    console.log(randomQuote);

    document.querySelector('.quote-phrase').textContent = randomQuote; 
    document.querySelector('.quote-author').textContent = randomAuthor; 
}
